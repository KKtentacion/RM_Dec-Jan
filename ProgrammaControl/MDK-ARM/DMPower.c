...
void Motor_control(int SetSpeed)
{
		...
		switch(Selection)
		{
			case 0:
			{
				MIT_CtrlMotor(&hcan1,0X02, 0, SetSpeed,0, 1, 0);	  //IMT控制模式对ID为0X02电机进行速度控制发送
				Selection++;
				break;
			}
			case 1:
			{
				MIT_CtrlMotor(&hcan1,0X03, 0, SetSpeed,0, 1, 0);			//IMT控制模式对ID为0X03电机进行速度控制发送
				Selection++;
				break;
			}
			case 2:
			{
				MIT_CtrlMotor(&hcan1,0X04, 0, SetSpeed,0, 1, 0);			//IMT控制模式对ID为0X04电机进行速度控制发送
				Selection=0;
				break;
			}
		}
		...
		switch(Selection)
		{
			case 0:
			{
				PosSpeed_CtrlMotor(&hcan1,0X102, 10, SetSpeed);	  //位置速度控制模式对ID为0X02电机进行速度控制发送
				Selection++;
				break;
			}
			case 1:
			{
				PosSpeed_CtrlMotor(&hcan1,0X103,  10, SetSpeed);			//位置速度控制模式对ID为0X03电机进行速度控制发送
				Selection++;
				break;
			}
			case 2:
			{
				PosSpeed_CtrlMotor(&hcan1,0X104,  10, SetSpeed);			//位置速度控制模式对ID为0X04电机进行速度控制发送
				Selection=0;
				break;
			}
		}
		...
		switch(Selection)
		{
			case 0:
			{
				Speed_CtrlMotor(&hcan1,0X202, SetSpeed);	  //速度控制模式对ID为0X02电机进行速度控制发送
				Selection++;
				break;
			}
			case 1:
			{
				Speed_CtrlMotor(&hcan1,0X203, SetSpeed);			//速度控制模式对ID为0X03电机进行速度控制发送
				Selection++;
				break;
			}
			case 2:
			{
				Speed_CtrlMotor(&hcan1,0X204, SetSpeed);			//速度控制模式对ID为0X04电机进行速度控制发送
				Selection=0;
				break;
			}
		}
